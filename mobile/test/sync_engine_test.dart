...
void main() {
  test('merges local-only, server-only and conflicting rows; server wins', () async {
    final api = _FakeApi(
      () => _resp(
        [
  ...
  test('a server reveal that overrides a local win triggers streak-decrease', () async {
    final api = _FakeApi(
      () => _resp(

...
const BLOCK = new Set([
  ...
  "rick", "rico", "riel", "roma", "rosa", "ross", "rudi", "rudy",
  "russ", "sade", "saul", "sega", "siam", "tate", "tess", "tito",
  "todd", "togo", "tojo", "tony", "tora", "tung", "tyne", "vega",
  "vera", "vlad", "yale", "zion",
  ...
  "abbas", "argus", "atlas", "audi", "bates", "bosch", "darts" /* keep? */,
  "denis", "dukes", "dumas", "earls", "ethos" /* greek loan, keep? */,
  "honda", "irons" /* surname */, "jesse", "jesus", "joans", "johns",
  "jones", "judas", "judah", "lewis", "linda", "louis", "mayas",
  "miles" /* common name */, "minas", "monks" /* sometimes name? keep */,
  "nexus" /* loan */, "nikes", "obama", "paris", "pesos",
